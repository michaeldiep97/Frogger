...
public class GamePanel extends JPanel{
	...
	private Lane lanes[];
	private Frog f;
	private File dFile, cFile;
	private Graphics page;
	
	//-----------------------------
	// Components
	//-----------------------------
	private JLabel timeLabel, distanceLabel, maxDistanceLabel, coinsLabel, maxCoinsLabel, gameOver;
	...
	public GamePanel() {
		...
		maxCoinsLabel = new JLabel ("HIGH SCORE: ");
	...
	public void paintComponent(Graphics page){
		...
		maxDistanceLabel.setFont(new Font(null , Font.PLAIN, 32 ));
		maxDistanceLabel.setText("HIGH SCORE: " + maxDistance + "m");
		...
		maxCoinsLabel.setFont(new Font(null , Font.PLAIN, 32 ));
		maxCoinsLabel.setText("HIGH SCORE: " + maxCoinCount);
		maxCoinsLabel.setLocation(WIDTH / 2, 0);
		maxCoinsLabel.setSize(new Dimension(WIDTH / 4, LANE_HEIGHT+50));
			...
			for (int index = 0; index < lanes.length; index++){
				...
				if (lanes[index].getCoin().getHitBox().intersects(Frog.getHitBox())){
					...
					if (Coin.getCoinCount() > maxCoinCount)
			  		...
			  		maxCoinsLabel.setText("HIGH SCORE: " + maxCoinCount); // Updates the max coin count
				}
			}
